...
(This is not a true history and is only a parable. Also it is definitely not my own invention but I can't figure out who the original source for this story is. Plausibly it's based on a misremembering of [Yan Tan Tethera](https://en.wikipedia.org/wiki/Yan_Tan_Tethera))
