...
Now \(||\sum\limits_{n \geq N} \langle x, e_n \rangle e_n|| = ||\sum\limits_{n \geq N} \langle y_i, e_n \rangle e_n + \sum\limits_{n \geq N} \langle x - y_i, e_n \rangle e_n|| \leq ||\sum\limits_{n \geq N} \langle y_i, e_n \rangle e_n|| + ||\sum\limits_{n \geq N} \langle x - y_i, e_n \rangle e_n|| < \frac{\epsilon}{2} +  \frac{\epsilon}{2} = \epsilon\) as desired.
